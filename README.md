# My solutions for rustlings v5.4.1

Working trough the rustlings examples, keeping my solutions if i need a quick lookup or want to look back at it at a later point.

[check out the rustlings project](https://github.com/rust-lang/rustlings)
